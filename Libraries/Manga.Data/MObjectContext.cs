...
namespace Manga.Data
{
    ...
    /// Object context
    /// </summary>
    public class MObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public MObjectContext(string nameOrConnectionString)
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            //Type configType = typeof(LanguageMap); // any of your configuration classes here
        ...
        {
            //little hack here until Entity Framework really supports stored procedure
