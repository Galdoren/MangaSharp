...
{
    /// <summary>
    /// Provides information about types in the current wpf application. 
    /// Optionally this class can look at all assemblies in the bin folder.
    /// </summary>
    public class WPFAppTypeFinder : AppDomainTypeFinder
    {
        #region Fields
        ...
        public WPFAppTypeFinder(MConfig config)
        {
