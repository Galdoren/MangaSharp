    ...
    public class PluginManager
    {
        ...
        public static void Initialize()
        {
            using (Locker.AcquireWriteLock())
            {
                ...
                var pluginFolder = new DirectoryInfo(Path.Combine(Environment.CurrentDirectory, PluginsPath));
                _shadowCopyFolder = new DirectoryInfo(Path.Combine(Environment.CurrentDirectory, ShadowCopyPath));
                ...
                try
                {
                    ...
                    foreach (var dfd in GetDescriptionFilesAndDescriptors(pluginFolder))
                    {
                        ...
                        if (!pluginDescriptor.SupportedVersions.Contains(MVersion.CurrentVersion, StringComparer.InvariantCultureIgnoreCase))
                        {
        ...
        public static void MarkPluginAsInstalled(string systemName)
        {
            ...
            var filePath = Path.Combine(Environment.CurrentDirectory, InstalledPluginsFilePath);
        ...
        private static Assembly PerformFileDeploy(FileInfo plug)
        {
            ...
            //if (AppDomain.CurrentDomain.ApplicationTrust.IsApplicationTrustedToRun)
            if(true)
            {
            ...
            Debug.WriteLine("Adding to AppDomain.CurrentDoman: '{0}'", shadowCopiedAssembly.FullName);
